...
export class vec3 {
    ...
    public set z ( z : number ) { this . values [ 2 ] = z ; }
...
export class mat2d {
    ...
    public static makeRotation ( radians : number , result : mat2d | null = null) : mat2d {
        if ( result === null ) result = new mat2d ( ) ;
        const s : number = Math . sin( radians ) , c : number = Math . cos ( radians ) ;
        result . values [ 0 ] = c ;
        result . values [ 1 ] = s ;
        result . values [ 2 ] = -s ;
        result . values [ 3 ] = c ;
    ...
    public static makeRotationFromVectors ( v1 : vec2 , v2 : vec2 , norm  = false , result : mat2d | null = null ) : mat2d {
        if ( result === null ) result = new mat2d ( ) ;
...
export class Math2D {
    ...
    public static createQuadraticBezierEnumerator ( start : vec2 , ctrl : vec2 , end : vec2  , steps  = 30 ) : IBezierEnumerator {
        return new BezierEnumerator ( start , end , ctrl , null , steps ) ;
    }

    public static createCubicBezierEnumerator ( start : vec2 ,ctrl0 : vec2 , ctrl1 : vec2 , end : vec2  , steps  = 30 ) : IBezierEnumerator {
    ...
    public static isPointOnLineSegment ( pt : vec2 , start : vec2 , end : vec2 , radius  = 2 ) : boolean {
...
export class BezierEnumerator implements IBezierEnumerator {
    ...
    public constructor ( start : vec2 , end : vec2 , control0 : vec2 , control1 : vec2 | null = null , steps  = 30 ) {
