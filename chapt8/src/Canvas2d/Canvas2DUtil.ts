...
export class Canvas2DUtil {
    ...
    public static state ( ctx: CanvasRenderingContext2D, save = true ) {
        if ( save === true ) {
            ctx.save();
        } else {
            ctx.restore();
    ...
    public static setLineState ( ctx: CanvasRenderingContext2D, lineWidth = 1.0, lineCap: LineCap = "butt", lineJoint: LineJoin = "miter", miterLimit = 10.0 ): void {
    ...
    public static setLineDashState ( ctx: CanvasRenderingContext2D, lineDashArray: number[], lineDashOffset = 0.0 ): void {
        ctx.setLineDash( lineDashArray );
        ctx.lineDashOffset = lineDashOffset;
    }

    public static setShadowState ( ctx: CanvasRenderingContext2D, shadowBlur = 0, shadowColor = "rgba(0, 0, 0, 0)", shadowOffsetX = 0, shadowOffsetY = 0 ): void {
    ...
    public static setRenderState ( ctx: CanvasRenderingContext2D, strokeStyle: string | CanvasGradient | CanvasPattern = "#000000", fillStyle: string | CanvasGradient | CanvasPattern = "#000000", globalAlpha = 1.0, compositeOperation: GlobalCompositeOperation = "source-over" ): void {
